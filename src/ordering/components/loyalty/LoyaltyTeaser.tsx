...
export function LoyaltyTeaser() {
  return (
    <div className="bg-gradient-to-r from-[#C55A1E] to-[#E87230] text-white p-6 rounded-lg shadow-md">
      ...
      <div className="mt-6">
        <button
          className="bg-white text-[#E87230] px-6 py-2 rounded-md font-semibold hover:bg-gray-100 transition-colors"
