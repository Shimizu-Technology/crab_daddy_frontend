                ...
                <div className="border border-gray-200 rounded-md p-4 mb-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center font-medium bg-gray-50 p-3 rounded-md">
                      ...
                      <span className="text-lg text-[#E87230]">${total.toFixed(2)}</span>
                    </div>
              ...
              <>
                {paymentMethod === 'credit_card' && (
                  <button
                    ...
                    disabled={isLoading}
                    className="px-4 py-2 bg-[#E87230] text-white rounded-md text-sm font-medium hover:bg-[#C55A1E] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#E87230]"
                  >
                ...
                {paymentMethod === 'cash' && (
                  <button
                    ...
                    className="px-4 py-2 bg-[#E87230] text-white rounded-md text-sm font-medium hover:bg-[#C55A1E] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#E87230] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="mr-3 px-4 py-2 bg-white border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#E87230]"
                >
                  Cancel
                </button>
              </>
