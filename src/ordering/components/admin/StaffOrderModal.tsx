          ...
          <form className="space-y-4 w-full px-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#E87230] focus:border-[#E87230]"
              />
            </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-10 bg-white border-t border-gray-200 shadow-lg" aria-label="Mobile navigation">
          ...
          <div className="p-3 flex justify-between items-center border-b border-gray-200">
            <div>
              ...
              <div className="text-lg font-bold text-[#E87230]">${orderTotal.toFixed(2)}</div>
            </div>
            {activeTab === 'order' && cartItems.length > 0 && (
              <button
                onClick={() => handleTabChange('customer')}
                className="bg-[#E87230] hover:bg-[#C55A1E] text-white py-2 px-5 rounded-md font-medium transition-colors"
              >
                Continue
              </button>
            )}
          ...
          <nav className="flex justify-between items-center py-1 px-2" aria-label="Primary mobile navigation">
            <button
              ...
              className={`flex flex-col items-center justify-center py-2 px-1 w-1/4 relative ${activeTab === 'menu' ? 'text-[#E87230] font-medium' : 'text-gray-600'}`}
            ...
            >
              ...
              {activeTab === 'menu' && <span className="absolute bottom-0 left-4 right-4 h-0.5 bg-[#E87230]"></span>}
            </button>
            
            <button
              onClick={() => handleTabChange('order')}
              className={`flex flex-col items-center justify-center py-2 px-1 w-1/4 relative ${activeTab === 'order' ? 'text-[#E87230] font-medium' : 'text-gray-600'}`}
            ...
            >
              <div className="h-6 flex items-center justify-center relative">
                ...
                {cartItemCount > 0 && (
                  <span className="absolute -top-2 -right-3 inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-[#E87230] rounded-full">
                    {cartItemCount}
                  </span>
                )}
              </div>
              <span className="text-xs mt-1 whitespace-nowrap text-center">Order</span>
              {activeTab === 'order' && <span className="absolute bottom-0 left-4 right-4 h-0.5 bg-[#E87230]"></span>}
            </button>
            
            <button
              onClick={() => handleTabChange('customer')}
              className={`flex flex-col items-center justify-center py-2 px-1 w-1/4 relative ${activeTab === 'customer' ? 'text-[#E87230] font-medium' : 'text-gray-600'}`}
            ...
            >
              ...
              {activeTab === 'customer' && <span className="absolute bottom-0 left-4 right-4 h-0.5 bg-[#E87230]"></span>}
            </button>
            
            <button
              onClick={() => handleTabChange('payment')}
              className={`flex flex-col items-center justify-center py-2 px-1 w-1/4 relative ${activeTab === 'payment' ? 'text-[#E87230] font-medium' : 'text-gray-600'}`}
            ...
            >
              ...
              {activeTab === 'payment' && <span className="absolute bottom-0 left-4 right-4 h-0.5 bg-[#E87230]"></span>}
            </button>
          </nav>
        </div>
      </div>
