  ...
  return (
    <div ref={selectRef} className={`relative ${className}`}>
      ...
      <button
        ...
        className={`flex items-center justify-between w-full px-3 py-2 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-crab-daddy-orange transition-all duration-200 ${selectedOption?.label.includes('(Active)') ? 'border-2 border-green-500 bg-green-50' : 'border border-gray-300 bg-white'}`}
      >
            ...
            {options.map((option) => (
              <div
                ...
                className={`cursor-pointer select-none relative py-3 px-4 flex items-center justify-between ${option.value === value
                  ? 'bg-crab-daddy-orange text-white font-medium'
                  : 'text-gray-900 hover:bg-crab-daddy-orange/10'
                }`}
              >
                ...
                {option.label.includes('(Active)') && (
                  <div className="flex items-center">
                    <span className={`flex items-center justify-center px-2 py-0.5 rounded-full text-xs ${option.value === value ? 'bg-white text-crab-daddy-orange' : 'bg-green-100 text-green-800'}`}>
                      Active
                    </span>
      ...
      <div className="py-2 px-3 border-t border-gray-100 overflow-x-auto">
        ...
        <div className="flex items-center gap-2 pb-1 flex-nowrap min-w-0 overflow-x-auto hide-scrollbar">
            ...
            <button
              ...
              className={`px-4 py-3 rounded-md transition-all duration-200 shadow-sm whitespace-nowrap flex-shrink-0 min-w-[110px] max-w-[150px] flex items-center justify-center
                ${activeFloor === floorNum 
                  ...
                  : 'bg-gray-100 text-gray-700 hover:bg-crab-daddy-orange/5 hover:text-crab-daddy-orange/70'}`}
            >
              Floor {floorNum}
            </button>
          ))}
          ...
          <button
            ...
            className="px-4 py-3 rounded-md transition-all duration-200 shadow-sm bg-gray-100 text-gray-700 hover:bg-crab-daddy-orange/10 hover:text-crab-daddy-orange hover:border hover:border-crab-daddy-orange/20 flex items-center justify-center whitespace-nowrap flex-shrink-0"
          >
          ...
          <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-md border border-gray-200 pointer-events-auto transform transition-all duration-200 ease-in-out mb-10">
            ...
            <div className="space-y-5">  {/* Increased spacing for touch */}
              ...
              <div className="col-span-2 mb-2">
                ...
                {/* Seat visualization with ability to edit labels */}
