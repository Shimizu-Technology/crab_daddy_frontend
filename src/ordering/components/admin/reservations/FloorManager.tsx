...
export function FloorManager({
  ...
  const resetZoom = () => {
    ...
    <div className="flex flex-col bg-white rounded-md w-full h-full relative overflow-hidden">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={`px-5 py-3 rounded-md transition-colors shadow-sm text-base font-medium min-w-[180px] text-center ${
                activeMode === 'seat' 
                  ? 'bg-crab-daddy-orange text-white border border-crab-daddy-orange/80' 
                  : 'bg-white text-gray-700 hover:bg-crab-daddy-orange/10 hover:text-crab-daddy-orange border border-gray-200'
              }`}
            >
            ...
            <button
              ...
              className="p-2 text-crab-daddy-orange hover:bg-crab-daddy-orange/10 rounded-md transition-colors"
              title="Refresh Data"
            >
              <RefreshCw size={18} />
            </button>
        ...
        <div className="flex items-center p-3 border-t border-gray-100">
          ...
          <div className="flex-none flex space-x-2 mr-6">
            {layout && Array.from(
              ...
              <button
                ...
                className={`px-5 py-3 rounded-md transition-colors shadow-sm text-base ${activeFloor === floorNum ? 'bg-crab-daddy-orange/10 text-crab-daddy-orange border border-crab-daddy-orange/20' : 'bg-gray-100 text-gray-700 hover:bg-crab-daddy-orange/5 hover:text-crab-daddy-orange/70'}`}
              >
                Floor {floorNum}
              </button>
            ))}
          ...
          <div className="flex-none flex items-center mx-auto">
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="p-3 rounded-md bg-crab-daddy-orange/10 hover:bg-crab-daddy-orange/20 active:bg-crab-daddy-orange/30 transition-colors border border-crab-daddy-orange/20"
                aria-label="Previous day"
                title="Previous day"
              >
                <ChevronLeft className="h-5 w-5 text-crab-daddy-orange" />
              </button>
              ...
              <div className="relative flex-1 sm:w-48">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-3 bg-white border border-gray-300 rounded-lg shadow-sm text-base focus:ring-2 focus:ring-crab-daddy-orange/30 focus:border-crab-daddy-orange outline-none"
                />
              </div>
              ...
              <button
                ...
                title="Next day"
              >
                <ChevronRight className="h-5 w-5 text-crab-daddy-orange" />
              </button>
            </div>
          ...
          <div className="flex-none flex items-center space-x-2 ml-6">
            <button
              onClick={toggleGrid}
              className={`px-4 py-3 text-base rounded-md transition-colors shadow-sm ${showGrid ? 'bg-crab-daddy-orange/10 text-crab-daddy-orange border border-crab-daddy-orange/20' : 'bg-gray-100 text-gray-600 hover:bg-crab-daddy-orange/5 hover:text-crab-daddy-orange/70'}`}
            >
      ...
      {seatWizard.active && (
        <div className="bg-crab-daddy-orange/20 border border-crab-daddy-orange/30 rounded-lg p-3 mb-3 flex flex-wrap sm:flex-nowrap items-center justify-between shadow-sm">
          <div className="flex items-center space-x-4">
            <div className="bg-crab-daddy-orange p-2 rounded-full shadow-sm">
              <UserRound className="text-white" size={22} />
            </div>
            <div>
              <div className="font-bold text-lg text-crab-daddy-orange">
                Seating: {seatWizard.occupantName}
              </div>
              <div className="font-medium text-gray-700 flex items-center flex-wrap gap-2">
                <span className="bg-crab-daddy-orange/10 px-2 py-1 rounded-md border border-crab-daddy-orange/20 inline-flex items-center">
                  <Users2 size={16} className="mr-1 text-crab-daddy-orange" />
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className={`px-5 py-3 text-base font-medium rounded-md text-white shadow-sm transition-colors ${seatWizard.selectedSeatIds.length === seatWizard.occupantPartySize ? 'bg-crab-daddy-orange hover:bg-crab-daddy-orange/90 active:bg-crab-daddy-orange/80' : 'bg-crab-daddy-orange/40 cursor-not-allowed'}`}
            >
              Confirm Seating
            </button>
          </div>
        ...
        >
          ...
          <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-300 z-10 bg-white/70 backdrop-blur-sm ${isLoading ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            <div className="flex flex-col items-center bg-white/80 px-8 py-6 rounded-lg shadow-md">
              <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-crab-daddy-orange mb-4 shadow-sm"></div>
                    ...
                    {section.seats?.map((seat, seatIndex) => {
                      ...
                      return (
                          ...
                          className={`absolute rounded-full flex items-center justify-center text-sm font-medium
                            ${isOccupied ? 'bg-green-500 border-green-600 text-white' : 
                              (seat.id && seatWizard.selectedSeatIds.includes(seat.id)) ? 
                                'bg-crab-daddy-orange border-crab-daddy-orange/80 text-white' : 
                        ...
                        >
                          ...
                          {seat.id && seatWizard.selectedSeatIds.includes(seat.id) && (
                            <span className="absolute -top-2 -right-2 bg-crab-daddy-orange text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold shadow-md border border-white">
                        ...
                        className={`p-2 rounded-md text-sm cursor-pointer relative transition-colors border shadow-sm ${
                          activeMode === 'seat' 
                            ? currentReservation?.id === res.id
                              ? 'bg-crab-daddy-orange/20 border-crab-daddy-orange/40 text-crab-daddy-orange-800'
                              : isReservationSeatable(res)
                                ? 'bg-white hover:bg-crab-daddy-orange/5 border-gray-200'
                                : 'bg-gray-100 opacity-60 border-gray-200'
                            : 'bg-gray-50 hover:bg-crab-daddy-orange/5 active:bg-crab-daddy-orange/10 border-gray-200'
                        }`}
                        onClick={() => {
                ...
                {waitlist.length === 0 ? (
                  ...
                  <ul className="space-y-1">
                    {waitlist.map((wl) => (
                      <li 
                        key={`drawer-wl-${wl.id}`}
                        className="bg-gray-50 p-2 rounded-md hover:bg-crab-daddy-orange/5 active:bg-crab-daddy-orange/10 text-sm cursor-pointer relative transition-colors border border-gray-200 shadow-sm"
                      ...
                      >
                        ...
                        <div className="text-xs text-crab-daddy-orange/90 font-medium">{wl.status}</div>
                      </li>
                    ))}
                  </ul>
                )}
      ...
      <div className={`px-6 pb-6 w-full transition-opacity duration-300 ${drawerOpen ? 'hidden' : 'block'}`}>
        <div className="flex flex-row gap-6 w-full">
          ...
          <div className="flex-1 bg-white rounded-lg shadow-sm border border-gray-100 p-4">
            <h3 className="text-xl font-semibold mb-4 text-crab-daddy-orange">Reservations</h3>
                ...
                {isDataTransitioning && prevReservations.length > 0 ? (
                  ...
                  <div className="py-6 flex justify-center items-center">
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-crab-daddy-orange/60 rounded-full mr-2 animate-pulse"></div>
          ...
          {/* Waitlist entries */}
          <div className="flex-1 bg-white rounded-lg shadow-sm border border-gray-100 p-4">
            <h3 className="text-xl font-semibold mb-4 text-crab-daddy-orange">Waitlist</h3>
            ...
            {isLoadingSchedule ? (
                  ...
                  <ul className="space-y-2 min-h-[150px] opacity-30 transition-all duration-500 ease-in-out transform translate-y-0">
                    ...
                    {prevWaitlist.map((wl: any) => (
                      ...
                      >
                        ...
                        <div className="text-sm text-crab-daddy-orange/90 font-medium mt-1">Status: {wl.status}</div>
                      </li>
                    ))}
                  </ul>
                ) : (
              ...
              <ul className="space-y-2 min-h-[150px] opacity-100 transition-all duration-500 ease-in-out transform translate-y-0 animate-fadeIn">  {/* Enhanced transition */}
                {waitlist.map((wl: any) => (
                  <li 
                    key={`wl-${wl.id}`}
                    className="bg-gray-50 p-4 rounded-md hover:bg-crab-daddy-orange/5 active:bg-crab-daddy-orange/10 text-base cursor-pointer relative transition-colors border border-gray-200 shadow-sm"
                    onClick={() => toast.success(`Waitlist Entry: ${wl.contact_name || 'Guest'} (Party of ${wl.party_size})`)}
                  >
                    <div className="font-semibold text-base">{wl.contact_name || 'Guest'}</div>
                    <div className="text-sm text-gray-600 mt-1">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 flex flex-wrap justify-between items-center w-full mb-6 gap-4">
          <div className="flex items-center space-x-4">
            <button
              onClick={() => toggleGrid()}
              className="px-4 py-2 text-base rounded-md bg-crab-daddy-orange/10 text-crab-daddy-orange hover:bg-crab-daddy-orange/20 active:bg-crab-daddy-orange/30 transition-colors border border-crab-daddy-orange/20 shadow-sm"
            >
              {showGrid ? 'Hide Grid' : 'Show Grid'}
            </button>
            
            <div className="text-base text-gray-700 font-medium">
              <span className="text-crab-daddy-orange">Layout:</span> {layout?.name || 'Main Layout'}
            </div>
          </div>
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center">
              <span className="text-base text-gray-700 font-medium">
                <span className="text-crab-daddy-orange">Floor:</span> {activeFloor}
              </span>
            </div>
            
            <div className="flex items-center">
              <span className="text-base text-gray-700 font-medium">
                <span className="text-crab-daddy-orange">Zoom:</span> {Math.round(zoom * 100)}%
              </span>
            </div>
            
            <div className="flex items-center">
              <span className="text-base text-gray-700 font-medium">
                <span className="text-crab-daddy-orange">Sections:</span> {layout?.sections_data?.sections ? layout?.sections_data.sections.filter(s => (s.floorNumber || 1) === activeFloor).length : 0}
              </span>
            </div>
          </div>
        </div>
        ...
        {selectedReservation && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-auto">
              <div className="flex justify-between items-center p-4 border-b border-crab-daddy-orange/20 bg-crab-daddy-orange/5">
                <div className="flex items-center space-x-2">
                  <h3 className="text-xl font-semibold text-crab-daddy-orange">Reservation Details</h3>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-4">
                    <h4 className="font-semibold text-crab-daddy-orange border-b pb-2 border-crab-daddy-orange/20">Guest Information</h4>
                    <div className="flex items-center">
                      <div className="w-10 h-10 rounded-full bg-crab-daddy-orange/20 flex items-center justify-center mr-3">
                        <UserRound size={20} className="text-crab-daddy-orange" />
                      </div>
                      <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-4">
                    <h4 className="font-semibold text-crab-daddy-orange border-b pb-2 border-crab-daddy-orange/20">Reservation Details</h4>
                    <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-4 mb-6">
                  <h4 className="font-semibold text-crab-daddy-orange border-b pb-2 border-crab-daddy-orange/20">Additional Information</h4>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <button
                          ...
                          className="flex items-center justify-center gap-2 p-2 bg-crab-daddy-orange/10 text-crab-daddy-orange rounded-md hover:bg-crab-daddy-orange/20"
                        >
                          <Calendar size={16} />
                          No-show
                        </button>
