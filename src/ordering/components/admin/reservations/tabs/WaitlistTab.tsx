...
export default function WaitlistTab() {
  ...
  function renderWaitlistStatusBadge(status?: string) {
    ...
    switch (status.toLowerCase()) {
      case 'waiting':
        return (
          <span className="px-2.5 py-1 inline-flex text-xs leading-5 font-medium rounded-full bg-crab-daddy-orange/10 text-crab-daddy-orange border border-crab-daddy-orange/20 shadow-sm">
            waiting
          </span>
        );
      case 'seated':
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-3 mb-6">
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              type="text"
              className="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg shadow-sm text-sm focus:ring-1 focus:ring-crab-daddy-orange/30 focus:border-crab-daddy-orange outline-none"
            ...
            {searchedWaitlist.length === 0 ? (
              ...
              searchedWaitlist.map((w) => {
                ...
                return (
                  <tr
                    key={w.id}
                    className="hover:bg-crab-daddy-orange/5 cursor-pointer transition-colors relative"
                    onClick={() => {
