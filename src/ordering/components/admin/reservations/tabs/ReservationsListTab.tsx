    ...
    <div className="h-full flex flex-col p-4">
      ...
      <div className="mb-6 flex flex-col sm:flex-row justify-between sm:items-center gap-3">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2.5 bg-crab-daddy-orange text-white rounded-md text-sm font-medium hover:bg-crab-daddy-orange/90 transition-colors flex items-center justify-center"
        >
          ...
          <div className="relative flex-1 sm:flex-none sm:w-64">
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="p-2 rounded-md bg-crab-daddy-orange/10 hover:bg-crab-daddy-orange/20 active:bg-crab-daddy-orange/30 transition-colors border border-crab-daddy-orange/20"
                aria-label="Previous day"
                title="Previous day"
              >
                <ChevronLeft className="h-4 w-4 text-crab-daddy-orange" />
              </button>
              ...
              <div className="relative flex-1 sm:w-48">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2.5 bg-white border border-gray-300 rounded-lg shadow-sm text-sm focus:ring-1 focus:ring-crab-daddy-orange/30 focus:border-crab-daddy-orange outline-none"
                />
              </div>
              ...
              <button
                ...
                title="Next day"
              >
                <ChevronRight className="h-4 w-4 text-crab-daddy-orange" />
              </button>
            </div>
          </div>
      ...
      <div className="flex-1 min-h-[400px] flex flex-col relative transition-all duration-300 ease-in-out">
          ...
          <table className="min-w-full table-auto divide-y divide-gray-200 text-sm">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {searchedReservations.map((res) => (
                <tr
                  key={res.id}
                  className="hover:bg-crab-daddy-orange/5 cursor-pointer transition-colors"
                ...
                >
                  ...
                  <td className="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                    <button
                      ...
                      className="px-2.5 py-1 text-crab-daddy-orange bg-crab-daddy-orange/10 hover:bg-crab-daddy-orange/20 rounded-md border border-crab-daddy-orange/20 transition-colors"
                    >
                      View
                    </button>
                  </td>
        ...
        <div className={`md:hidden space-y-3 transition-opacity duration-300 ${!isLoading && searchedReservations.length > 0 ? 'opacity-100 relative' : 'opacity-0 absolute inset-0 pointer-events-none'}`}>
          {searchedReservations.map((res) => (
            <div 
              key={res.id}
              className="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden cursor-pointer hover:border-crab-daddy-orange/30 hover:bg-crab-daddy-orange/5 transition-colors"
              onClick={() => handleRowClick(res)}
            >
              <div className="p-3 border-b border-gray-100 flex justify-between items-center">
                ...
                <button 
                  ...
                  className="text-xs px-2 py-1 rounded-md bg-crab-daddy-orange/10 text-crab-daddy-orange hover:bg-crab-daddy-orange/20 border border-crab-daddy-orange/20 transition-colors"
                >
                  View
                </button>
              </div>
        ...
        <div className={`bg-white border border-gray-100 rounded-lg p-8 text-center shadow-sm transition-opacity duration-300 ${!isLoading && searchedReservations.length === 0 ? 'opacity-100 relative' : 'opacity-0 absolute inset-0 pointer-events-none'}`}>
          ...
          <button
            onClick={() => setShowCreateModal(true)}
            className="px-4 py-2 bg-crab-daddy-orange text-white rounded-md text-sm font-medium hover:bg-crab-daddy-orange/90 transition-colors inline-flex items-center"
          >
