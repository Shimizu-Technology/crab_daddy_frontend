...
export default function WaitlistForm({ onClose, onSuccess }: WaitlistFormProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-md mx-auto">
      {/* Header */}
      <div className="bg-crab-daddy-orange text-white p-4">
          ...
          <div className="flex items-center">
            ...
            <input
              ...
              className="
                ...
                focus:outline-none focus:ring-2 focus:ring-crab-daddy-orange/30 focus:border-crab-daddy-orange/50 transition-colors
              "
            />
          </div>
        </div>
          ...
          <button
            ...
            className={`
              ...
              ${isSubmitting
                ...
                : 'bg-crab-daddy-orange text-white hover:bg-crab-daddy-orange/90 active:bg-crab-daddy-orange/80'}
            `}
          >
