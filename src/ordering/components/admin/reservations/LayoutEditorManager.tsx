      ...
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-white bg-opacity-60 z-10">
          <div className="flex flex-col items-center">
            <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-crab-daddy-orange mb-4"></div>
            <p className="text-crab-daddy-orange">Loading layout editor...</p>
          </div>
        </div>
      )}
    </div>
