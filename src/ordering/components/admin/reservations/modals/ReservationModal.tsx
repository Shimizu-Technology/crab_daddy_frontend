      ...
      <div className="fixed inset-0 flex items-center justify-center overflow-y-auto p-2 sm:p-4">
        <div className="relative bg-white max-w-lg w-full sm:mx-4 rounded-lg shadow-lg my-2 sm:my-4">
          ...
          <div className="max-h-[75vh] overflow-y-auto p-4 sm:p-6">
            ...
            {isProcessingAction && (
              <div className="mb-4 flex items-center justify-center py-2 text-crab-daddy-orange">
                <div className="animate-spin h-5 w-5 border-2 border-crab-daddy-orange border-r-transparent rounded-full mr-2"></div>
                    ...
                    <div className="space-y-2">
                      {allSets.filter(set => set.length > 0).map((preference, idx) => (
                        <div key={idx} className="flex items-center">
                          <span className="text-xs bg-crab-daddy-orange/10 text-crab-daddy-orange px-2 py-0.5 rounded-full mr-2">
                            Option {idx + 1}
                          </span>
                          ...
                          {canAssignOption(preference) && (
                            <button
                              ...
                              className="ml-2 px-2 py-1 text-xs bg-crab-daddy-orange/20 text-crab-daddy-orange rounded-md hover:bg-crab-daddy-orange/30 transition-colors"
                            >
                              Assign
                            </button>
                          )}
              ...
              */}
              ...
              <div className="mt-6 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-3 bg-crab-daddy-orange text-white rounded-md hover:bg-crab-daddy-orange/90 transition-colors font-medium"
                  disabled={isProcessingAction}
                >
                  Edit
                </button>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="
                    ...
                    focus:ring-2 focus:ring-crab-daddy-orange/40 focus:border-crab-daddy-orange
                  "
                />
              </div>
              ...
              <div>
                ...
                <div className="p-2 bg-gray-50 border border-gray-200 rounded text-sm text-gray-700">
                  ...
                  <button
                    ...
                    className="mt-3 w-full sm:w-auto px-4 py-2.5 bg-crab-daddy-orange/20 text-crab-daddy-orange rounded-md hover:bg-crab-daddy-orange/30 transition-colors font-medium text-sm"
                  >
              ...
              */}
              ...
              <div className="mt-6 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                ...
                <button
                  onClick={handleOpenSeatMap}
                  className="w-full sm:w-auto px-4 py-3 bg-crab-daddy-orange/20 text-crab-daddy-orange rounded-md hover:bg-crab-daddy-orange/30 transition-colors font-medium"
                  disabled={isProcessingAction}
                >
                  Seat Map
                </button>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[60] p-4">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-xl max-w-lg w-full mx-auto my-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-end mt-6">
              <button
                className="w-full sm:w-auto px-4 py-3 bg-crab-daddy-orange text-white rounded-md hover:bg-crab-daddy-orange/90 transition-colors text-base font-medium"
