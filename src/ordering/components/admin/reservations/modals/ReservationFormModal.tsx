          ...
          {hasMultipleLocations && (
            <div className="mb-4">
              <label className="block text-gray-600 text-sm mb-1.5" htmlFor="location">
                Location <span className="text-crab-daddy-orange">*</span>
              </label>
          ...
          <div className="space-y-4 mb-6">
            ...
            <div>
              <label className="block text-gray-600 text-sm mb-1.5" htmlFor="date">
                Date <span className="text-crab-daddy-orange">*</span>
              </label>
              <div className="relative">
                ...
                <DatePicker
                  ...
                  className="w-full py-2.5 px-3 border border-gray-200 rounded-md focus:ring-2 focus:ring-crab-daddy-orange/40 focus:outline-none transition duration-150"
            ...
            <div>
              <label className="block text-gray-600 text-sm mb-1.5" htmlFor="time">
                Time <span className="text-crab-daddy-orange">*</span>
              </label>
              ...
              {date && timeslots.length === 0 && !loading && (
                <div className="flex items-center text-xs text-crab-daddy-orange mt-1.5">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div>
              <label className="block text-gray-600 text-sm mb-1.5" htmlFor="party_size">
                Party Size <span className="text-crab-daddy-orange">*</span>
                {time && (
                  <span className="ml-2 text-xs">
                    {isLoadingCapacity ? (
                      ...
                      <span className="text-crab-daddy-orange bg-crab-daddy-orange/10 px-1.5 py-0.5 rounded-full">
                        No capacity
                      </span>
                    )}
                  </span>
        ...
        <div>
          ...
          <div className="mb-4">
            <label className="block text-gray-600 text-sm mb-1.5" htmlFor="contact_name">
              Contact Name <span className="text-crab-daddy-orange">*</span>
            </label>
            <input
              type="text"
              value={contactName}
          ...
          <div className="mb-4">
            <label className="block text-gray-600 text-sm mb-1.5" htmlFor="contact_phone">
              Contact Phone <span className="text-crab-daddy-orange">*</span>
            </label>
            <input
              type="tel"
              value={contactPhone}
      ...
      <div className="flex justify-between mt-6">
        <div>
          <p className="text-xs text-gray-500">
            <span className="text-crab-daddy-orange">*</span> Required fields
          </p>
        </div>
        <div className="flex space-x-2">
          ...
          <button
            className="px-4 py-2 bg-crab-daddy-orange text-white rounded-md hover:bg-crab-daddy-orange/90 transition-colors flex items-center"
    ...
    {showSeatMapModal && (
      <div className="fixed inset-0 w-full h-full z-50 flex items-center justify-center" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
        ...
        <div className="bg-white rounded-lg shadow-lg max-w-3xl w-full mx-4 relative z-10 max-h-[90vh] overflow-y-auto">
          ...
          <button
            className="px-4 py-2 bg-crab-daddy-orange text-white rounded-md hover:bg-crab-daddy-orange/90 transition-colors"
