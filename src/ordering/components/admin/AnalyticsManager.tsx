            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-wrap gap-1">
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded ${timePreset === '30min' ? 'bg-[#E87230] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  30 Min
                </button>
                <button
                  onClick={() => applyTimePreset('1h')}
                  className={`px-2 py-1 text-xs rounded ${timePreset === '1h' ? 'bg-[#E87230] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  1 Hour
                </button>
                <button
                  onClick={() => applyTimePreset('3h')}
                  className={`px-2 py-1 text-xs rounded ${timePreset === '3h' ? 'bg-[#E87230] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  3 Hours
                </button>
              </div>
            ...
            <div className="flex flex-col mt-2 sm:mt-0">
              ...
              <div className="flex flex-wrap gap-1">
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded ${timePreset === '6h' ? 'bg-[#E87230] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  6 Hours
                </button>
                <button
                  onClick={() => applyTimePreset('12h')}
                  className={`px-2 py-1 text-xs rounded ${timePreset === '12h' ? 'bg-[#E87230] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  12 Hours
                </button>
                <button
                  onClick={() => applyTimePreset('24h')}
                  className={`px-2 py-1 text-xs rounded ${timePreset === '24h' ? 'bg-[#E87230] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  24 Hours
                </button>
              </div>
            ...
            <div className="flex flex-col mt-2 sm:mt-0">
              ...
              <div className="flex flex-wrap gap-1">
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded ${timePreset === '7d' ? 'bg-[#E87230] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  7 Days
                </button>
              </div>
