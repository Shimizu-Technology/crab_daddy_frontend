        ...
        <form onSubmit={handleRestaurantUpdate} className="space-y-8 mt-6">
          ...
          <div className="bg-white border border-gray-100 rounded-lg shadow-sm overflow-hidden transition-all duration-200 hover:shadow-md">
            <div className="bg-gray-50 px-4 py-3 border-b border-gray-100">
              <h3 className="text-lg font-medium text-gray-900 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#E87230]" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="space-y-4 mt-4 pt-4 border-t border-gray-100">
                ...
                <Input
                  ...
                  placeholder="e.g., https://crabdaddy-orders.com"
                  type="url"
                />
                ...
                <Input
                  ...
                  placeholder="e.g., https://facebook.com/crabdaddy"
                  type="url"
                />
                ...
                <Input
                  ...
                  placeholder="e.g., https://instagram.com/crabdaddy"
                  type="url"
                />
                ...
                <Input
                  ...
                  placeholder="e.g., https://twitter.com/crabdaddy"
                  type="url"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#E87230] focus:border-[#E87230] sm:text-sm transition-all duration-200"
                />
            ...
            <div className="p-5 space-y-5">
              <div className="bg-gray-50 p-4 rounded-md border border-gray-100">
                ...
                <input
                  ...
                  className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#E87230] focus:border-[#E87230] sm:text-sm transition-all duration-200"
                />
              ...
              <div className="bg-gray-50 p-4 rounded-md border border-gray-100">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                  <input
                    type="color"
                    value={restaurant.admin_settings?.email_header_color || '#E87230'}
                    onChange={(e) => setRestaurant({
                      ...restaurant, 
                      admin_settings: {
                        ...restaurant.admin_settings,
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-[#E87230] focus:ring-[#E87230] border-gray-300 rounded"
                      />
                  ...
                  <label className="block mt-2">
                    ...
                    <input
                      ...
                      className="mt-1 block w-full cursor-pointer text-sm
                                ...
                                file:bg-[#E87230] file:text-white
                                hover:file:bg-[#C55A1E]"
                    />
                  </label>
                </div>
          ...
          <div className="flex justify-end pt-4">
            <button
              type="submit"
              disabled={loading}
              className="w-full sm:w-auto px-5 py-2 bg-[#E87230] text-white font-medium 
