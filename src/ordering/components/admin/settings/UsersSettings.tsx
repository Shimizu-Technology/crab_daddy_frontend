    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="space-y-4 mb-4">
        ...
        <div className="w-full">
          <input
            ...
            className="border border-gray-300 rounded-md px-3 py-2
                       ...
                       focus:ring-[#E87230] w-full transition-colors duration-200"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className="border border-gray-300 rounded-md px-2 py-1.5 text-sm
                       focus:outline-none focus:ring-1 focus:ring-[#E87230] flex-1 min-w-[120px]
          ...
          <select
            ...
            className="border border-gray-300 rounded-md px-2 py-1.5 text-sm
                       focus:outline-none focus:ring-1 focus:ring-[#E87230] w-20
                       transition-colors duration-200"
          >
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2 bg-[#E87230] text-white rounded-md hover:bg-[#C55A1E]
