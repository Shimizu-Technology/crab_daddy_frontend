    ...
    <div className="mt-8 bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="flex justify-end p-2 bg-gray-50">
        <button
          ...
          className="px-4 py-2 bg-crab-daddy-orange text-white rounded font-medium hover:bg-crab-daddy-blue"
        >
          Save All Settings
        </button>
      </div>
        ...
        <div className="px-4 py-5 sm:p-6 space-y-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              type="button"
              className="px-3 py-1 bg-crab-daddy-orange text-white text-sm rounded hover:bg-crab-daddy-blue flex items-center"
            >
