        ...
        >
          ...
          <div className="bg-white border-t border-gray-200 p-4 flex justify-end space-x-3 shrink-0">
            ...
            <button
              ...
              className={`px-4 py-2 ${isProcessingPayment ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#E87230] hover:bg-[#C55A1E]'} text-white rounded-md text-sm md:text-base font-medium focus:outline-none flex items-center justify-center min-w-[80px] min-h-[44px]`}
            >
