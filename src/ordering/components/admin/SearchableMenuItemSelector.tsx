  ...
  const renderSearchStep = () => (
    <div className="p-4 space-y-4">
      ...
      <div className="relative">
        <input
          type="text"
          className="w-full border border-gray-300 rounded-md px-4 py-2 pl-10 focus:ring-[#E87230] focus:border-[#E87230]"
      ...
      {loading ? (
        <div className="py-8 flex justify-center">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#E87230]"></div>
        </div>
      ) : (
                    ...
                    <div className="flex justify-between">
                      <div>
                        ...
                        {item.option_groups && item.option_groups.length > 0 && (
                          <div className="mt-1 text-xs text-[#E87230] font-medium">
                            Customizable
                          </div>
                        )}
                      </div>
