      ...
      <div className="bg-white rounded-lg max-w-5xl w-full max-h-[90vh] overflow-y-auto p-6 animate-slideUp transform-gpu will-change-transform">
            ...
            <div className="border-b pb-4 mb-4">
              ...
              <div className="flex flex-wrap items-center space-x-2 space-y-2">
                ...
                <button
                  ...
                  className="px-2 py-1 bg-[#E87230] text-white text-sm rounded hover:bg-[#C55A1E]"
                >
                  + Create Group
                </button>
              </div>
        ...
        <div className="mt-4 flex justify-end space-x-2">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#E87230] text-white rounded-md hover:bg-[#C55A1E] transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
          >
