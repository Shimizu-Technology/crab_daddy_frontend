    ...
    try {
      ...
      >
        ...
        <div className="flex items-start mb-3">
          <div className="bg-[#E87230] bg-opacity-10 p-2 rounded-lg mr-3 flex-shrink-0">
            <ShoppingBag className="h-5 w-5 text-[#E87230]" />
          </div>
        ...
        <div className="flex space-x-2">
          <button
            ...
            className="flex-1 bg-[#E87230] text-white px-3 py-2 rounded-lg font-medium text-sm hover:bg-[#C55A1E] transition-colors shadow-sm"
          >
            View Order
          </button>
          <button
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="border-b border-gray-200 overflow-x-auto overflow-y-hidden whitespace-nowrap">
            <nav className="flex -mb-px" role="tablist">
              ...
              {isStaffOnly ? (
                <div className="flex-shrink-0 whitespace-nowrap px-4 py-4 border-b-2 border-[#E87230] text-center font-medium text-sm text-[#E87230]">
