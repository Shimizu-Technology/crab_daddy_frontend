      ...
      <div className="flex justify-between items-center mb-6">
        ...
        {activeTab === 'management' && (
          <button
            ...
            className="px-4 py-2 bg-[#E87230] text-white rounded-md hover:bg-[#C55A1E] transition-colors"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#E87230]"
                  required
                />
              </div>
              <div>
        ...
        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4">
          ...
          {loading ? (
            <div className="flex justify-center items-center py-8">
              <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-[#E87230]"></div>
            </div>
          ) : (
                        ...
                        <tr key={staffMember.id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <button
                              ...
                              className="text-[#E87230] hover:text-[#C55A1E]"
                            >
