    ...
    <div className="p-4">
      ...
      <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-3 sm:py-2 bg-[#E87230] text-white rounded-md font-medium hover:bg-[#C55A1E] focus:outline-none focus:ring-2 focus:ring-[#E87230] focus:ring-opacity-50 flex items-center justify-center space-x-2 shadow-sm"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none"
               viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
