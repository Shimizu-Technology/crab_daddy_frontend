          ...
          <div className="mb-6">
            <div className="flex items-center mb-2">
              <label className="inline-flex items-center cursor-pointer">
                ...
                />
                <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#E87230]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#E87230]"></div>
          ...
          {enableTracking && (
            <>
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  className="bg-[#E87230] hover:bg-[#C55A1E] text-white py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-[#E87230] focus:ring-opacity-50"
