          ...
          <div className="p-6 overflow-y-auto max-h-[90vh] md:max-h-[unset]">
            ...
            <div className="mt-6 p-4 border border-gray-200 rounded-md bg-gray-50">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">Pickup available at Crab Daddy (Guam)</p>
                  <p className="mt-1 text-xs text-gray-500">Usually ready in 2 hours</p>
                  <button className="mt-1 text-xs text-[#E87230] hover:text-[#C55A1E] underline">
