        ...
        <div className="relative bg-white rounded-lg w-full min-h-screen sm:min-h-0 sm:h-auto max-w-2xl sm:max-h-[90vh] overflow-y-auto">
          ...
          <div className="pt-6 px-4 sm:px-6 pb-6 max-w-md mx-auto">
            ...
            <div className="mt-6 bg-white rounded-2xl p-5 mx-auto shadow-md border border-gray-100">
              ...
              <div className="divide-y divide-gray-100">
                ...
                <div className="py-3 sm:py-4 flex items-start gap-3">
                  <div className="bg-crab-daddy-orange/10 p-2.5 rounded-lg">
                    <Calendar className="h-5 w-5 text-crab-daddy-orange" />
                  </div>
                ...
                <div className="py-3 sm:py-4 flex items-start gap-3">
                  <div className="bg-crab-daddy-orange/10 p-2.5 rounded-lg">
                    <Users className="h-5 w-5 text-crab-daddy-orange" />
                  </div>
                  <div className="flex-1 min-w-0">
                ...
                {(confirmation.phone || confirmation.email) && (
                  <div className="py-3 sm:py-4 flex items-start gap-3">
                    <div className="bg-crab-daddy-orange/10 p-2.5 rounded-lg">
                      <User className="h-5 w-5 text-crab-daddy-orange" />
                    </div>
                ...
                <div className="py-3 sm:py-4 flex items-start gap-3">
                  <div className="bg-crab-daddy-orange/10 p-2.5 rounded-lg">
                    <MapPin className="h-5 w-5 text-crab-daddy-orange" />
                  </div>
                  <div className="flex-1 min-w-0">
                ...
                {confirmation.specialRequests && (
                  <div className="py-3 sm:py-4 flex items-start gap-3">
                    <div className="bg-crab-daddy-orange/10 p-2.5 rounded-lg">
                      <MessageSquare className="h-5 w-5 text-crab-daddy-orange" />
                    </div>
                    <div className="flex-1 min-w-0">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <button
                onClick={onClose}
                className="flex-1 sm:flex-none order-1 sm:order-2 rounded-full bg-crab-daddy-orange flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-crab-daddy-orange/90 transition-colors"
              >
                Done
              </button>
            </div>
        ...
        <form onSubmit={handleSubmitReal} className="space-y-3 sm:space-y-4">
          ...
          <div className="form-group mb-6">
            <label className="flex items-center gap-2 mb-2" htmlFor="date">
              <Calendar size={18} className="text-crab-daddy-orange" />
            ...
            <div className="relative">
              <DatePicker
                ...
                className="block w-full rounded-md border border-gray-300 px-3 py-2 sm:py-3 text-base sm:text-lg
                           focus:border-crab-daddy-orange focus:outline-none focus:ring-1 focus:ring-crab-daddy-orange"
            ...
            <div className="h-8 text-sm text-gray-600 mt-2 flex items-center">
              <div className="flex items-center gap-4 mt-2">
                <div className="flex items-center">
                  <div className="h-3 w-3 bg-crab-daddy-orange rounded-full mr-2"></div>
                  <span>Available</span>
                </div>
                <div className="flex items-center">
          ...
          <div className="form-group mb-6">
            <label className="flex items-center gap-2 mb-2" htmlFor="partySize">
              <Users size={18} className="text-crab-daddy-orange" />
                  ...
                  <button
                    ...
                    className={`h-12 sm:h-14 rounded-lg flex items-center justify-center transition-colors touch-manipulation text-lg
                      ${formData.partySize === i+1
                        ? 'bg-crab-daddy-orange text-white font-medium shadow-sm' 
                        : 'bg-white text-gray-800 border border-gray-300 hover:border-crab-daddy-orange hover:text-crab-daddy-orange active:bg-gray-50'}`}
          ...
          {hasMultipleLocations && (
            <div className="form-group mb-4 relative">
              <label className="flex items-center gap-2 mb-2" htmlFor="location">
                <MapPin size={18} className="text-crab-daddy-orange" />
          ...
          <div className="form-group mb-6">
            <label className="flex items-center gap-2 mb-2" htmlFor="time">
              <Clock size={18} className="text-crab-daddy-orange" />
                    ...
                    {timeSlots.map((slot: string) => (
                      <button
                        ...
                        className={`py-3 px-1 text-sm sm:text-base rounded-md border text-center transition-colors touch-manipulation
                          ${formData.time === slot
                            ? 'bg-crab-daddy-orange text-white border-crab-daddy-orange font-medium' 
                            : 'bg-white text-gray-800 border-gray-300 hover:border-crab-daddy-orange hover:text-crab-daddy-orange active:bg-gray-50'}`}
                      >
                        {formatTime(slot)}
                      </button>
                    ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div>
                ...
                <User size={18} className="text-crab-daddy-orange" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div>
                ...
                <Phone size={18} className="text-crab-daddy-orange" />
              ...
              <div>
                ...
                <Mail size={18} className="text-crab-daddy-orange" />
            ...
            <div className="form-group mb-8">
              <label className="flex items-center gap-2 mb-2" htmlFor="specialRequests">
                <AlertCircle size={18} className="text-crab-daddy-orange" />
            ...
            <div className="mt-8 sticky bottom-0 bg-white pt-3 pb-5 px-2 -mx-2 sm:mx-0 sm:px-0 z-10 border-t border-gray-100 sm:border-0 shadow-sm sm:shadow-none">
              <button 
                type="submit" 
                className="w-full rounded-lg bg-crab-daddy-orange px-4 sm:px-6 py-4 text-white text-base sm:text-lg font-semibold
                           hover:bg-crab-daddy-orange/90 focus:outline-none focus:ring-2 focus:ring-crab-daddy-orange focus:ring-offset-2
