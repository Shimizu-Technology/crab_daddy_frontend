...
class NotificationStorageService {
  ...
  private storageKey: string = 'crab_daddy_notifications';
  private pendingAcknowledgmentsKey: string = 'crab_daddy_pending_acknowledgments';
  private lastSyncKey: string = 'crab_daddy_last_notification_sync';
