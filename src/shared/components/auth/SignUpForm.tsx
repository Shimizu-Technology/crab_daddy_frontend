            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="firstName" className="block text-sm font-medium text-gray-700 mb-1">
                  <User className="inline-block w-4 h-4 mr-1 text-[#E87230]" />
                ...
                <input
                  ...
                  className="
                    ...
                    focus:outline-none focus:ring-2 focus:ring-[#E87230] focus:border-transparent
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">
                  <Mail className="inline-block w-4 h-4 mr-1 text-[#E87230]" />
              ...
              <div>
                <label htmlFor="phone" className="block text-sm font-medium text-gray-700 mb-1">
                  <Phone className="inline-block w-4 h-4 mr-1 text-[#E87230]" />
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-gray-700 mb-1">
                  <Lock className="inline-block w-4 h-4 mr-1 text-[#E87230]" />
              ...
              <button
                ...
                className="
                  ...
                  text-white bg-[#E87230] border border-transparent rounded-md
                  hover:bg-[#C55A1E] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#E87230]
