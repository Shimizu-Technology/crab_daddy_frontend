      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold text-[#E87230] mb-4">Crab Daddy</h2>
            <p className="text-gray-300 mb-4">
              Fresh seafood boils and coastal flavors in Guam. Experience our signature
              Cajun, Garlic, and Lemon Pepper sauces in a vibrant atmosphere.
            </p>
            <div className="flex space-x-4">
              {restaurant?.facebook_url && (
                <a
                  ...
                  className="text-gray-300 hover:text-[#E87230]"
                >
                  <Facebook />
                </a>
              )}
