          ...
          <div className="mt-2 flex space-x-2">
            <button
              ...
              className="flex items-center px-2.5 py-1 text-xs font-medium rounded-md 
                bg-[#E87230] text-white hover:bg-[#C55A1E] transition-colors"
            >
                ...
                <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                          ...
                          <div className="mt-4">
                            ...
                            <div className="mt-1 flex rounded-md shadow-sm">
                              <input
                                ...
                                className="flex-1 min-w-0 block w-full px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-[#E87230] focus:border-[#E87230]"
                                placeholder="10"
                              />
                            </div>
                          </div>
                  ...
                  <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button 
                      ...
                      disabled={isLoading}
                      className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-[#E87230] text-base font-medium text-white hover:bg-[#C55A1E] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#E87230] sm:ml-3 sm:w-auto sm:text-sm disabled:opacity-50"
                    >
                      {isLoading ? (
                        <>
