...
export function MobileSelect({
  ...
  const customStyles: StylesConfig = {
    control: (provided, state) => ({
      ...provided,
      borderColor: state.isFocused ? '#E87230' : '#e5e7eb',
      borderWidth: '1px',
      boxShadow: state.isFocused ? '0 0 0 2px rgba(232, 114, 48, 0.2)' : 'none',
      '&:hover': {
        borderColor: state.isFocused ? '#E87230' : '#d1d5db',
      },
      padding: '4px 8px',
    ...
    option: (provided, state) => ({
      ...provided,
      backgroundColor: state.isSelected ? '#E87230' : state.isFocused ? 'rgba(232, 114, 48, 0.1)' : 'white',
      ...
      '&:active': {
        backgroundColor: state.isSelected ? '#E87230' : 'rgba(232, 114, 48, 0.2)',
      },
    ...
    dropdownIndicator: (provided, state) => ({
      ...provided,
      color: state.isFocused ? '#E87230' : '#9ca3af',
      padding: '0 8px',
