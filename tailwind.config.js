...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Crab Daddy brand colors
        'crab-daddy-orange': '#E87230',
        'crab-daddy-blue': '#0870B0',
        'crab-daddy-light-blue': '#4A9ED6',
        'crab-daddy-dark-orange': '#C55A1E',
        'crab-daddy-light-orange': '#F59D67',
        'crab-daddy-gold': '#F0C14B',
      },
      animation: {
