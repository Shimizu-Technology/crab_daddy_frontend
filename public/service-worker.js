// Service Worker for Crab Daddy Web App
// Handles push notifications and offline functionality

const CACHE_NAME = 'crabdaddy-cache-v1';
...
self.addEventListener('push', event => {
  ...
  try {
    ...
    data = {
      ...
      body: 'Something new happened in Crab Daddy.',
      icon: '/icons/icon-192.png'
    };
  }
  
  const title = data.title || 'Crab Daddy';
  const options = {
    body: data.body || 'New notification from Crab Daddy',
    icon: data.icon || '/icons/icon-192.png',
    badge: data.badge || '/icons/badge-96.png',
    tag: data.tag || 'crabdaddy-notification',
    data: data.data || {},
